...
drop table ebs_bttemp_lt50m;
drop view ebs_bttemp_lt50m;
create table ebs_bttemp_lt50m as
select year, sum(gtempwgt) avgbsbt, sum(stempwgt) avgbsst from geartemp_subarea 
group by year;


select * from ebs_bttemp_lt50m order by year;
