...
# [Basic Design-Based SAP Data Products](`r paste0(link_repo)`) <img src="https://avatars.githubusercontent.com/u/94422627?s=200&v=4" alt="Logo." align="right" width="139" height="139"/>
...
**Shannon Hennessey** (Shannon.Hennessey AT noaa.gov; [\@ShannonHennessey](https://github.com/ShannonHennessey))  
...
> The code in this repository is regularly being updated and improved. Please refer to [releases](https://github.com/afsc-gap-products/gap_products/releases) for finalized products and project milestones.
...
Use the below [bibtext citations](https://github.com/afsc-gap-products/gap_products/blob/main/CITATION.bib), as cited in our group’s [citation repository](https://github.com/afsc-gap-products/citations/blob/main/cite/bibliography.bib) for citing the data created and maintained in this repo. Add “note = {Accessed: mm/dd/yyyy}” to append the day this data was accessed.
Included here are AFSC RACE Groundfish and Shellfish Assessment Program’s:
...
If you see that the data, product, or metadata can be improved, you are invited to create a  [pull request](`r paste0(link_repo, "/pulls")`), [submit an issue to the GitHub organization](`r "https://github.com/afsc-gap-products/data-requests/issues"`), or  [submit an issue to the code's repository](`r paste0(link_repo, "/issues")`).
