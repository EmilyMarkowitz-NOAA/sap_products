...
This quarto book is based off the [NOAA-quarto-book](https://github.com/nmfs-opensci/NOAA-quarto-book) GitHub repo designed by Eli Holmes and the similar data product book for the [Groundfish Assessment Program](https://afsc-gap-products.github.io/gap_products/). 
